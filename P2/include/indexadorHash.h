...
class IndexadorHash {
    public:
        ...
        IndexadorHash(const string& directorioIndexacion);
            /* Constructor para inicializar IndexadorHash a partir de una indexación previamente realizada que habrá sido almacenada en
            ?directorioIndexacion? mediante el método ?bool GuardarIndexacion()?. Con ello toda la parte privada se inicializará convenientemente, igual
            que si se acabase de indexar la colección de documentos. En caso que no exista el directorio o que no contenga los datos de la indexación se
        ...
        void VaciarIndicePreg();
            /* Borra todos los términos del
            indexación de la pregunta actual.
            índice de la pregunta: toda */
